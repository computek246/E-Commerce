...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.UserToken", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.RoleClaim", b =>
                {
                    b.HasOne("eCommerce.Security.Entities.Role", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("eCommerce.Security.Entities.UserClaim", b =>
                {
                    b.HasOne("eCommerce.Security.Entities.User", "User")
                        .WithMany("Claims")
